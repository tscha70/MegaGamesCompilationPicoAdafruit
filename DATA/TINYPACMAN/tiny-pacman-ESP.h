...
if ((Sprite[0].type==PACMAN)&&((Sprite[0].x<x)&&(Sprite[0].x>x-6))&&(((Sprite[0].y==y)&&(Sprite[0].Decalagey<6))||((Sprite[0].y==y-1)&&(Sprite[0].Decalagey>5)))) {DotsDestroy_TPACMAN(dotscount_TPACMAN);if (Menreturn==1) {TimerGobeactive_TPACMAN=LEVELSPEED_TPACMAN;Gobeactive_TPACMAN=1;}else{Sound_TPACMAN(10,10);Sound_TPACMAN(50,10);}}
}}
if (Menreturn==1) {
